...
# 学习器
learners = {
    #'CGD': r'-l (trees.HoeffdingTreeMeasure -a CGD -o '+  OUTPUT_DIR + ')',
    'IMAC': r'-l (trees.HoeffdingTreeMeasure -M -i 1 -a INC  -o '+  OUTPUT_DIR + ')',
    'OSM': r'-l (trees.HoeffdingTreeMeasure  -M -a OSM -o '+  OUTPUT_DIR + ')',
    'VFDT': r'-l (trees.HoeffdingTreeMeasure -M -a None -o '+  OUTPUT_DIR + ')',
}
